...
class Vue():
     ...
     def affichageTour(self):
         i= 0
         #print(self.parent.modele.towerList)
         while i < len(self.parent.modele.towerList):
             x = self.parent.modele.towerList[i].x
             y = self.parent.modele.towerList[i].y
             #print("""Lis le commentaire de cette ligne") # tu as oublie d'enlever la tour de towerList,
             ...
             self.parent.modele.towerList.pop()
